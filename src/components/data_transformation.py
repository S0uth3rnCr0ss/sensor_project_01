...
class DataTransaformation:
    ...
    def initiate_data_transformation(self):
        logging.info("Ended initiate data transformation method of data transformation class")
        ...
        try:
            ...
            os.makedirs(os.dirnbname(preprocessor_path),exist_ok=True)
